...
function nightMode(enable) {
    var elm = document.documentElement;
    if(enable) {
        $(document.body).addClass('nightMode');
        addClass(elm, "nightMode");
    } else {
        $(document.body).removeClass('nightMode');
...
function getReadingTime() {
    ...
    console.log("getReadingTime:" + readingTimeMinutes);
...
var getAnchorOffset = function(target, horizontal) {
    ...
    if (horizontal) {
        ...
        /*return document.body.clientWidth **/ return Math.floor(offset / window.innerWidth);
    }
    
    var offset =  $(elem).offset().top
    return Math.floor(offset / window.innerHeight);
    // return elem.offsetTop;
}
